...
func NewDNAController(service *dna.DNAService) *DNAController {
...
func (c *DNAController) AnalyzeDNASeq(ctx *gin.Context) {
	...
	gcContent, err := c.service.AnalyzeGCContent(file)
...
// func (c *DNAController) AlignSequences(ctx *gin.Context) {
